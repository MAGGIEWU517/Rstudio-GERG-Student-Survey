...
sHIST2 <- function(d,v,h,xl,br) {
  ...
  gp<-ggplot(data=d, aes(x = v)) +
     geom_histogram(breaks=seq(0, xl, by = br),
                 ...
                 fill="#56B4E9") +
  labs(title = head) +
  labs(x=paste(c("0",xls),collapse = "-"), y="Frequency")
...
```{r, echo=FALSE, warning=FALSE}
TE1<-sHIST2(DataID3,TIPI.E1,"Composite Variable: Extraverted, enthusiastic. AND (Not)Reserved, quiet.",8,1)
TE2<-sHIST2(DataID3,TIPI.E2,"Composite Variable: Critical, quarrelsome. AND (Not)Sympathetic, warm.",8,1)
TE3<-sHIST2(DataID3,TIPI.E3,"Composite Variable: Dependable, self-disciplined. AND (Not)Disorganized, careless.",8,1)
TE4<-sHIST2(DataID3,TIPI.E4,"Composite Variable: Anxious, easily upset. AND (Not)Calm, emotionally stable.",8,1)
TE5<-sHIST2(DataID3,TIPI.E5,"Composite Variable: Open to new experiences, complex. AND (Not)Conventional, uncreative.",8,1)
```